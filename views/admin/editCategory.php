    ...
    <div class="col-md-6">
        <div class="card shadow border-0">
            ...
            <div class="card-body p-4">
                ...
                <form action="index.php?controller=admin&action=editCategory&id=<?= $category->id_categories ?>" method="POST">
                    <div class="mb-4">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="index.php?controller=admin&action=categories" class="btn btn-outline-secondary">Annuler</a>
